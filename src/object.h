...
public:
	...
	void ChangeType(int type, bool synced = false);
	void BringToFront();
	...
	void OnAftermove();
	void OnSpawn();
	void OnDeath(bool synced = false);
	...
	void Delete(int synced = 0);			// mark for deletion at end of frame
